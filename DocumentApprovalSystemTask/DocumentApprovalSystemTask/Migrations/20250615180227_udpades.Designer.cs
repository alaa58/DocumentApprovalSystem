...
namespace DocumentApprovalSystemTask.Migrations
{
    ...
    [Migration("20250615180227_udpades")]
    partial class udpades
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DocumentApprovalSystemTask.Domain.Entities.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("DocumentApprovalSystemTask.Domain.Entities.Employee", b =>
                {
                    b.HasOne("DocumentApprovalSystemTask.Domain.Entities.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("DocumentApprovalSystemTask.Domain.Entities.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
